// Standalone compact prompts — stripped of Anthropic-specific imports
// Original: src/services/compact/prompt.ts
// Modified: removed bun:bundle, feature flags, proactive module
// All prompt templates and formatting logic preserved exactly
