    ...
    def _register_all_tools(self) -> None:
        ...
        self.register(ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter("subagent_type", "string", "Type of subagent to delegate to",
        ...
        self.register(ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter("stream_type", "string", "Type of stream (thinking/working/result)",
        ...
        self.register(ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter("timeout", "number", "Timeout in seconds (max 30)", default=10),
            ]
        ))
        
        self.register(ToolDefinition(
            name="bash_execute",
            description="Execute bash command. Returns stdout, stderr, and exit code.",
            category=ToolCategory.CODE,
            parameters=[
                ToolParameter("command", "string", "Bash command to execute", required=True),
                ToolParameter("timeout", "number", "Timeout in seconds (max 15)", default=5),
            ]
        ))
